...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      ...
      size: {
        default: "h-12 px-6 py-3 min-h-[44px] touch-manipulation",
        sm: "h-10 sm:h-10 rounded-full px-4 text-xs min-h-[44px] touch-manipulation",
        lg: "h-14 rounded-full px-10 text-base min-h-[44px] touch-manipulation",
        icon: "h-12 w-12 sm:h-12 sm:w-12 rounded-full min-h-[44px] min-w-[44px] touch-manipulation",
      },
    },
    defaultVariants: {
      variant: "default",
